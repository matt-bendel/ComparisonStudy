...
class DataTransform:
    ...
    def __init__(self, noise_std, resolution, mag_only=False, normalize=None, rotation_angles=0, random_crop=True,
                 rss_target=False, train_data=True, image_size=320):
        """
        Args:
    ...
    def __call__(self, kspace, target, attrs, fname, slice):
        ...
        coil_compressed_x = x
        kspace = fft(coil_compressed_x, (1, 0))  # (320, 320, 1)
...
def create_arg_parser():
    ...
    parser.add_argument('--snorm', action='store_true', default=True, help='Turns on spectral normalization')
    ...
    parser.add_argument('--normalize', type=str, default='std',
                        help='normalization type (None "std", "constant", "kspace", or "max")')
    ...
    parser.add_argument("--train", default=True, action='store_true',
                        help="to differentiate between training and val data; used while accessing the sens maps")
    return parser
