...
import torch
from utils.fastmri.data import CombinedSliceDataset, SliceDataset
...
class FastMriDataModule(pl.LightningDataModule):
    """
    Data module class for fast data sets.

    This class handles configurations for training on fast data. It is set
